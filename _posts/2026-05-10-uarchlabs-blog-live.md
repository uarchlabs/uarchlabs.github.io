---
layout: post
title: "Introducing uarchlabs and the Pacino blog series"
author: Jeff Nye
date: 2026-05-10
series: "Announcement"
...
[uarchlabs](https://uarchlabs.com) is an open source hardware design organization. We build high performance processors and publish everything — the RTL, the design decisions, and the AI-assisted methodology used to produce them.

The first project is [Pacino](https://github.com/uarchlabs/pacino): an 8-issue
...
ambitious — a simple pipeline would not stress the methodology.

This blog series documents the design and the process. Posts cover
...
results will be published. We are making transparency part of the point.

The next post covers the project rationale, methodology, and workflow in detail. A FAQ covering scope, tooling, and design targets is at [uarchlabs.com/faq.html](https://uarchlabs.com/faq.html).
